...
def create_new_folder(folder_name):
    if os.path.isdir(get_path_to_file(folder_name)) == False:
        os.mkdir(get_path_to_file(folder_name))
        print('\nПапка с именем "{}" создана в директории "{}"'.format(folder_name, get_path_to_file('')))
...
def dialog_window():
    source_folder = input('Введите имя папки, изображения в которой вы хотите конвертировать:\n')
